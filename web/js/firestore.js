 ...
 */
export async function obtenerOcrearAnfitrion(nombre = null, email = null) {
  try {
...
export async function crearEvento(nombre, fechaISO, participantesSeleccionados = [], etiquetasSeleccionadas = [], anfitrionInfo = null) {
  try {
    ...
    // Si no se proporciona, crear anfitrión efímero por defecto
    const anfitrion = anfitrionInfo || {
      tipo: 'efimero',
      sesionId: generarSesionIdAnfitrion(),
      nombreAnfitrion: null,
      userId: null,
 ...
 */
export async function marcarEventoActivo(eventoId) {
  try {
    if (!eventoId) {
      return {
        ok: false,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo marcar el evento como activo'
    };
  }
}
...
export async function eliminarEvento(eventoId) {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo eliminar el evento'
    };
  }
}
 ...
 */
export async function crearParticipante(eventoId, nombre) {
  try {
    if (!eventoId || !nombre) {
      return {
        ok: false,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo crear el participante'
    };
  }
}
 ...
 */
export async function actualizarParticipante(participanteId, eventoId, nombre) {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo actualizar el participante'
    };
  }
}
...
export async function eliminarParticipante(participanteId) {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo eliminar el participante'
    };
  }
}
 ...
 */
export async function listarEtiquetas(eventoId) {
  try {
    if (!eventoId) {
      return {
        ok: true,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudieron cargar las etiquetas'
    };
  }
}
 ...
 */
export async function guardarEtiquetas(eventoId, etiquetas) {
  try {
    if (!eventoId) {
      return {
        ok: false,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudieron guardar las etiquetas'
    };
  }
}
 ...
 */
export async function activarTimerEvento(eventoId, minutos) {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo activar el timer'
    };
  }
}
 ...
 * @param {string} eventoId - ID del evento
 */
export async function desactivarTimerEvento(eventoId) {
  try {
    if (!eventoId) {
      return {
        ok: false,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo desactivar el timer'
    };
  }
}
 ...
 */
export async function aumentarTiempoTimer(eventoId, minutosAdicionales = 5) {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudo aumentar el tiempo del timer'
    };
  }
}
 ...
 */
export function escucharTimerEvento(eventoId, callback) {
  if (!eventoId) {
 ...
 * @param {string} eventoId - ID del evento
 */
export async function revelarResultadosEvento(eventoId) {
  try {
    if (!eventoId) {
      return {
        ok: false,
    ...
    return {
      ok: false,
      error: error.message || 'No se pudieron revelar los resultados'
    };
  }
}
 ...
 */
export async function buscarEventoPorPIN(pin) {
  try {
    ...
    const eventosRef = collection(db, 'eventos');
    const q = query(eventosRef, where('pin', '==', pinNormalizado));
    const querySnapshot = await getDocs(q);
 ...
 */
export async function listarPlantillasParticipantes() {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudieron cargar las plantillas de participantes'
    };
  }
}
 ...
 */
export async function crearPlantillaParticipante(nombre) {
  try {
 ...
 */
export async function eliminarPlantillaParticipante(plantillaId) {
  try {
    if (!plantillaId) {
      return {
        ok: false,
 ...
 */
export async function listarPlantillasEtiquetas() {
  try {
    ...
    return {
      ok: false,
      error: error.message || 'No se pudieron cargar las plantillas de etiquetas'
    };
  }
}
 ...
 */
export async function crearPlantillaEtiqueta(nombre) {
  try {
    if (!nombre || !nombre.trim()) {
      return {
        ok: false,
 ...
 */
export async function eliminarPlantillaEtiqueta(plantillaId) {
  try {
    if (!plantillaId) {
      return {
        ok: false,
...
export { normalizarFechaISO, formatearFechaParaUI };
